...
export default function TopSellingProducts() {
    return (
        <div className="p-6 bg-[#F7F9FB] rounded-2xl">
            <h3 className="text-lg font-semibold text-black mb-2">Top Selling Products</h3>
                ...
                <table className="w-full">
                    ...
                    <thead>
                        <tr className="border-b border-gray-200">
                            <th className="text-left py-3 px-0 text-xs text-black/40">
                                Name
                            </th>
                            <th className="text-right py-3 px-0 text-xs text-black/40">
                                Price
                            </th>
                            <th className="text-right py-3 px-0 text-xs text-black/40">
                                Quantity
                    ...
                    <tbody>
                        {productData.map((product, index) => (
                            <tr key={index} className="border-b border-gray-100 last:border-b-0">
                                <td className="py-4 px-0 text-xs text-black">
                                    {product.name}
                                </td>
                                <td className="py-4 px-0 text-xs text-black text-right">
